        ...
        <div className="modal-box w-11/12 max-w-5xl">
          <div>
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <button type="submit" className="text-xl w-full gap-2 text-white bg-pink-500 py-2 px-4 rounded-md hover:bg-pink-700 transform-all duration-300 mt-5">Submit</button>
            </form>
          </div>
